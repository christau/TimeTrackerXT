...
public class TaskTimes extends ListActivity implements DialogInterface.OnClickListener {
    ...
    private static final String SELECTED_RANGE_END = "selected_range_end";
    private static final String SELECTED_RANGE_START = "selected_range_start";
    private static final String EDIT_ACTION_BUNDLE_KEY = "edit_action";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(EDIT_ACTION_BUNDLE_KEY)) {
                action = savedInstanceState.getInt(EDIT_ACTION_BUNDLE_KEY);
            }
            if (savedInstanceState.containsKey(SELECTED_RANGE_START)) {
                selectedRange = new TimeRange(
                        savedInstanceState.getLong(SELECTED_RANGE_START),
                        savedInstanceState.getLong(SELECTED_RANGE_END)
                        );
            }
        }
    }
    ...
    protected void onSaveInstanceState( Bundle bundle ) {
        bundle.putInt(EDIT_ACTION_BUNDLE_KEY, action);
        if (selectedRange != null) {
            bundle.putLong(SELECTED_RANGE_START, selectedRange.getStart());
            bundle.putLong(SELECTED_RANGE_END, selectedRange.getEnd());
        }
    }
